...
export const Equipamentos = () => {
    ...
    const Cadastrar = (event) => {
      ...
      axios({
        method: "post",
        url: "http://appleviedavi.azurewebsites.net/api/Equipamentos",
        data: formData,
    ...
    const Listar = () => {
      axios.get('http://appleviedavi.azurewebsites.net/api/Equipamentos')
      .then(resposta => {
    ...
    const Remover = (id) => {
      axios.delete('http://appleviedavi.azurewebsites.net/api/Equipamentos/'+id)
      .then(() => {
        Listar();
      })
      .catch(erro => console.log(erro))
          ...
          <main className="container">
            ...
            {produtos.map(item => 
              <div className="card" key={item.id}>
                <img src={"http://appleviedavi.azurewebsites.net/StaticFiles/Images/"+item.imagem} alt="" />
                <div>
